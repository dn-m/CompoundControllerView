...
SWIFT_CLASS("_TtC18ControllerElements4Dial")
@interface Dial : CALayer
...
- (void)rampTo:(float)newValue over:(double)duration;
@end


SWIFT_CLASS("_TtC18ControllerElements6Slider")
